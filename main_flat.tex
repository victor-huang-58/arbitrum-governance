...
Figure~\ref{fig:dip} shows the distribution of \textit{fraction\_ai}
...
\begin{figure}[H]
  ...
  \caption{\textbf{Bimodal Distribution of AI-Detection Scores.}
    Histogram of Pangram \textit{fraction\_ai} scores for all scored posts
    (15,891 posts with at least 20 words). The distribution is strongly bimodal:
    the majority of posts cluster at or near 0 (predominantly human-written) or
    at or near 1 (predominantly AI-generated), with limited mass in the intermediate
    range. The Hartigan dip statistic rejects unimodality at $p < 0.001$,
    supporting the use of a binary classification threshold at 0.70.}
  \end{singlespace}
  \label{fig:dip}
\end{figure}
