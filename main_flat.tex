...
A model of endogenous posting, reading, and voting---derived from primitives---shows how this can happen: because readers respond to the \emph{expected} contamination of the forum, its signal value can collapse at a discrete, hysteretic tipping point while the \emph{realized} A.I.\ share is still low---strictly below the level that would mechanically destroy reading value---and reducing A.I.\ volume afterward does not restore the forum.
...
used it, so replacing it costs nothing quantitative.
