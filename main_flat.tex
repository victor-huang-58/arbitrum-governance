...
\begin{figure}[H]
  ...
  \caption{\textbf{Bimodal Distribution of AI-Detection Scores.}
    ...
    (15,802 posts with at least 20 words). 90\% of posts score below 0.10
    (blue, predominantly human-written) and 8\% score above 0.85 (red,
    predominantly AI-generated), with negligible mass in between. The dashed
    vertical line marks the classification threshold at 0.70. The sharp
    bimodality supports the threshold classifier: most posts are unambiguously
    human or AI, not hybrid.}
  \end{singlespace}
  \label{fig:dip}
\end{figure}
