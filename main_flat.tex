...
Figure~\ref{fig:fiscal} quantifies the economic stakes of this allocation activity.
Over the sample period, the DAO deployed roughly \$220 million in ARB-denominated
grants and incentive programs---approximately 8\% of the initial \$3.5 billion
treasury at prevailing prices---across the four proposal categories.
Treasury deployment accelerates sharply following the LTIPP program in H1 2024.
The cumulative depletion curve underscores why the quality of governance deliberation
matters: each proposal vote is a real economic decision with consequences for how
hundreds of millions of dollars are allocated.
