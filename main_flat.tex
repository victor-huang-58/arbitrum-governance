...
Calibrating to the data, the forum generated net social benefits equivalent to saving 555 words of delegate research effort per proposal---all destroyed at the tipping point.
...
early 2023---but at negligible volume. AI posts constituted approximately 5\% of forum volume at the QLR break (November 2023) and approximately 5\% at the Claude~3 break (March 2024). The large-scale volume surge did not arrive until late 2024, reaching 15--20\% of forum traffic nine to twelve months after the signal collapsed. A volume mechanism requires contamination to precede collapse; the data show the reverse.
...
\]
The forum is thus fragile by design: each post provides only 13 words' worth of net informational surplus per delegate---just 5.3\% of its gross information value---so that a 5.3\% contamination rate is precisely sufficient to push the expected return on reading to zero. Integrating across the thread, using the unrounded difference $I_H - c_r = 237 - 224.44 = 12.56$ words per post:
\[
  \bar{n} \cdot (I_H - c_r) = 44.2 \times 12.56 \approx 555 \text{ words per delegate per proposal}.
\]
