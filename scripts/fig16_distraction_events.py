...
# NOTE: /tmp/matched_proposals.csv is a temporary working file generated by
# the distraction analysis scripts. Its path is intentionally left as /tmp/.

CSV_PATH = "/tmp/matched_proposals.csv"
if not os.path.exists(CSV_PATH):
    raise FileNotFoundError("Run chow_test.py first to build /tmp/matched_proposals.csv")
